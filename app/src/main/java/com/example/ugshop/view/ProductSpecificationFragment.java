...
import com.example.ugshop.ProductSpecificationAdapter;
import com.example.ugshop.ProductSpecificationModel;
...
public class ProductSpecificationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        productSpecificationModelList.add(new ProductSpecificationModel("T-Shirt","Large"));
        productSpecificationModelList.add(new ProductSpecificationModel("T-Shirt","Large"));
        productSpecificationModelList.add(new ProductSpecificationModel("T-Shirt","Large"));
        productSpecificationModelList.add(new ProductSpecificationModel("T-Shirt","Large"));
        productSpecificationModelList.add(new ProductSpecificationModel("T-Shirt","Large"));
        ...
        //TODO: Here only one error found
